...
export default function Hero() {
  return (
    <>
      <div
        className="w-full relative z-10 px-4 md:px-8 pt-24 pb-16"
        style={{
          background:
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            className="font-display font-bold font-syne text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-foreground leading-[1.1] tracking-tight mb-6 scale-y-95"
          >
            Your Music.
            <br />
