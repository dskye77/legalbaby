      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="max-w-3xl text-center px-4">
          ...
          <p className="text-muted-foreground text-lg md:text-xl leading-relaxed mb-8">
            We&apos;re building something bigger than a platform. We&apos;re creating a new
            standard for how independent artists get paid, get heard, and get the
            respect they deserve. The future of music is independent. The future is
            LEGAL BABY.
          </p>
